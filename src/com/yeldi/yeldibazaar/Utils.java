...
public final class Utils {
	...
	private static final String[] FRIENDLY_SIZE_FORMAT = {"%.0f B", "%.0f KiB",
			"%.1f MiB", "%.2f GiB"};
	...
	public static void copy(InputStream input, OutputStream output,
			...
			ProgressListener.Event templateProgressEvent) throws IOException {
	...
	public static int countSubstringOccurrence(File file, String substring)
			throws IOException {
		int count = 0;
